...
- **Result:** our region scores 7,567 by standard MEP, and 6,908 when bikes and walkers use only roads people would feel safe on (walks capped at 20 minutes).
...
- **Result:** 6,908 → 5,791, a 16.2% drop (23.0% if bikes may use any road).
...
### ☐ Lesson 32. Neighbourhood driving danger: 1.3%, then 8.9% with real routes
...
- **Mistake / lesson:** the nearby-roads version explained **1.3%** of the map, 77% of it just county. Following each trip's real route (step 40) raised it to **8.9%**, mostly within counties.
- **Result:** $0.08 to $0.40 a mile; Hernando $0.17, Hillsborough $0.09.
- **You should be able to answer:** Why did following real routes raise 1.3% to 8.9%?
...
- **What:** 16.2% drop; counties 12.8% (Pasco) to 20.7% (Hernando); best neighbourhood −41%.
...
- **Result:** rankings barely change (0.986).
...
- **Result:** bike 67.8%, car 28.2%, walk 3.9% of the drop.
- **You should be able to answer:** Explain the 100-point example.

### ☐ Lesson 36. Who is hit hardest
- **What:** neighbourhoods with more carless households lose more (14.0% → 19.1%).
...
- **Mistake / lesson:** say the weak points first: cycling "switched off", potential vs real travel, 8.9% local, who pays.
