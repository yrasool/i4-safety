...
of travelling, add that cost into MEP, and see how much the score changes. **Answer: it drops 16.2%** (on roads people would actually walk and bike).
...
- **Here:** carless households vs MEP drop: **+0.27** (moderate). Before vs after rankings: **0.986** (almost identical).
...
> Only 8.9% of the differences come from local danger (1.3% before routes were followed); the rest is which modes people use.
