...
| 5 | A **road-by-road safety model** (safety curve + Empirical Bayes) to make driving danger vary by place | 8 Sep | ✅ | Works, but local danger is only 1.3% of the map |
...
| "The fake-map problem is solved by our own travel times" | it wasn't | local driving danger (1.3%) |
