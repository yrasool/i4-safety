...
| 67 | 16 Sep | **Bike reach counted roads almost nobody rides.** Standard MEP lets a bike use any road but a motorway, including 45-mph arterials; about 7 points of the 23.4% headline came from that | **your idea** to measure where people would actually bike | low-stress bike network plus 250 m hops shipped (steps 41–43); headline **16.2%** with the walking changes. See ASSUMPTIONS L |
| 68 | 16 Sep | **Walking counted 40-minute walks and any road.** People here walk a few minutes, in neighbourhoods, not along fast roads | **your point** that nobody walks 40 minutes to a store | walks capped at 20 minutes (FDOT's own nonmotorised cap) and limited to low-stress roads |
| 69 | 16 Sep | **Untagged local streets were all assumed 25 mph**, calling fast rural roads low-stress. 84–100% of local-street miles lack a speed tag in every county | checking why Hernando looked so well connected | Florida statutory defaults: 30 mph where 1,000+ people per square mile, 55 mph elsewhere |
| 70 | 16 Sep | **Hernando's connectivity was blamed on the speed-tag problem** — it wasn't | measuring which neighbourhoods were in its big island | it is Spring Hill's planned grid (63 of 80) plus trails; the suspicion was withdrawn |
| 71 | 16 Sep | **Validation tested a slightly different model from the one shipped** — one drive rate per origin instead of one per travel-time band, giving 17.5% where MEP gave 17.6% | the number checker failed on it | step 26 now charges each band its routed rate, exactly as step 23 does |
